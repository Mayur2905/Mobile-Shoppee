...
<body>
    ...
    <!-- Main -->
        ...
        $query = "SELECT product.price AS Price, product.id, product.name AS Name FROM product_user JOIN product ON product_user.product_id = product.id WHERE product_user.user_id='$user_id' and status='Added To Cart'";
